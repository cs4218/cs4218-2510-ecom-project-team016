...
describe("CreateProduct", () => {
  ...
  test("submits product successfully", async () => {
    ...
    await waitFor(() => {
      ...
      const [[, formDataArg]] = axios.post.mock.calls;
      expect(formDataArg.get("name")).toBe("Laptop");
      expect(formDataArg.get("description")).toBe("A powerful laptop");
      expect(formDataArg.get("price")).toBe("1500");
      expect(formDataArg.get("quantity")).toBe("5");
      expect(formDataArg.get("photo")).toBe("");
      expect(formDataArg.get("category")).toBe("cat1");
